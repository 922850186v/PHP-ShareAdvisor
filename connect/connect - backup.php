...
if(count($errors) === 0){
    ...
    $query = "INSERT INTO udetails (username,email,password,gender) VALUES ('$username','$email','$password','$gender')";
...
if(isset($_POST['login_user'])){
    ...
    if(count($errors) == 0){
        ...
        $query = "SELECT * FROM udetails WHERE email='$email' AND password='$password'";
